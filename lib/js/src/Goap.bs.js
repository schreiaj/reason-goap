...
function actionToJs(param) {
  return {
          name: param[/* name */0],
          preconditions: param[/* preconditions */1],
          results: param[/* results */2],
          cost: param[/* cost */3]
        };
}

function actionFromJs(param) {
  return /* record */[
          /* name */param.name,
          /* preconditions */param.preconditions,
          /* results */param.results,
          /* cost */param.cost
        ];
}

function stateJSON(json) {
  return /* record */[
...
function actionJSON(json) {
  return /* record */[
          /* name */Json_decode.field("name", Json_decode.string, json),
          /* preconditions */Json_decode.field("preconditions", (function (param) {
                  return Json_decode.list(stateJSON, param);
                }), json),
...
exports.actionToJs = actionToJs;
exports.actionFromJs = actionFromJs;
exports.stateJSON = stateJSON;
